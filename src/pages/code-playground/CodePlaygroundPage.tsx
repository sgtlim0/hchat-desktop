...
import { usePlaygroundStore } from '@/entities/playground/playground.store'
...
export function CodePlaygroundPage() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 p-6"><p className="text-text-tertiary text-sm text-center py-12">{t('playground.empty')}</p></div>
    </div>
  )
}
