# Works AI 스크린샷 심층 분석 + 구현 방안

> 분석일: 2026-03-03
> 소스: wrks.ai 서비스 5개 화면 스크린샷

---

## 1. 스크린샷 분석

### 1-1. 홈 대시보드 (`wrks.ai/ko/chat`)
...
### 1-5. 내 계정 / 사용량 (`wrks.ai/ko/my-page`)
...
**목표**: wrks.ai 스타일 비서 선택 그리드 + 카테고리 필터
